...
void startMatching3DFromFile(Eigen::Matrix3f& transformation_matrix, Eigen::Vector3f& translation_vector, std::string model_filename_, std::string scene_filename_)
{
